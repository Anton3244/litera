...
//
// Перевіряємо два види слів, де вигадка помітна одразу:
//
...
//
// Була ще спроба звіряти твердження цілком — брати з речення найрідші
// слова й шукати їх у творі. Вона не працює: добрий переказ за означенням
// написано іншими словами, і перевірка позначала правильні речення.
// Такий звіт привчає себе не читати, тому його прибрано.
//
